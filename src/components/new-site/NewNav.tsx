    ...
    children: [
      {
        ...
        description: "Deepfakes & AI-generated images and video",
      ...
      },
      {
        ...
        description: "Voice clones & synthetic speech detection",
        icon: navIcons.audio,
      },
      {
        key: "identity",
        ...
        href: "/solutions/kyc",
        description: "Forged IDs, selfies & AI-generated documents",
        icon: navIcons.idCard,
      },
      {
        key: "halo",
        label: "Halo · On-device",
        href: "/halo",
        description: "Real-time deepfake detection on live calls — with Qualcomm",
        icon: navIcons.halo,
      },
      {
        key: "documentation",
