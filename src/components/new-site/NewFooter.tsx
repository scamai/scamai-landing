        ...
        <div className="grid gap-10 md:grid-cols-4">
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4 pt-1">
              <a href="https://x.com/scam_ai" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors" aria-label="Follow us on X (Twitter)" onClick={() => trackOutbound("https://x.com/scam_ai", "twitter")}>
