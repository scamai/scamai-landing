...
export default function NewLanding() {
  ...
  return (
    <main className="bg-black text-white" role="main">
      ...
      <section className="landing-section relative overflow-hidden bg-black" aria-label="How It Works - Upload Analyze Verify Deepfakes">
          ...
          <AnimatedSection>
            <div className="text-center mb-12 lg:mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6 leading-[1.1]">
                Three steps to verify any media
              </h2>
              <p className="max-w-2xl mx-auto text-base sm:text-lg text-gray-300 leading-relaxed">
                Upload any image, video, or audio file. Our Eva-v1 AI model analyzes it in seconds. Get a confidence score — verified authentic or detected as AI-generated.
              </p>
            </div>
          </AnimatedSection>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 lg:gap-12">
            <AnimatedSection delay={0.1}>
              <div className="text-center">
                <img
                  src="/how-it-works/upload.svg"
                  alt="Step 1: Upload any image, video, or audio file to ScamAI for deepfake detection and synthetic media analysis"
                  width={240}
                  height={240}
                  className="mx-auto mb-6 rounded-2xl"
                />
                <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[#245FFF] mb-2 sm:text-xs">Step 1</p>
                <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Upload Media</h3>
                <p className="text-sm text-gray-400 leading-relaxed">
                  Drag and drop or select any image, video, or audio file. We support JPG, PNG, WebP, MP4, and WAV formats up to 50MB.
                </p>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.2}>
              <div className="text-center">
                <img
                  src="/how-it-works/analyze.svg"
                  alt="Step 2: ScamAI Eva-v1 AI model analyzes media for deepfakes, GAN artifacts, face swaps, and synthetic manipulation patterns"
                  width={240}
                  height={240}
                  className="mx-auto mb-6 rounded-2xl"
                />
                <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[#245FFF] mb-2 sm:text-xs">Step 2</p>
                <h3 className="text-lg sm:text-xl font-bold text-white mb-2">AI Analysis</h3>
                <p className="text-sm text-gray-400 leading-relaxed">
                  Our Eva-v1 model examines pixel patterns, GAN artifacts, metadata, and frequency anomalies to detect synthetic media and deepfakes.
                </p>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.3}>
              <div className="text-center">
                <img
                  src="/how-it-works/verify.svg"
                  alt="Step 3: Receive instant deepfake detection results with confidence scores showing AI-generated or verified authentic content"
                  width={240}
                  height={240}
                  className="mx-auto mb-6 rounded-2xl"
                />
                <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[#245FFF] mb-2 sm:text-xs">Step 3</p>
                <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Get Results</h3>
                <p className="text-sm text-gray-400 leading-relaxed">
                  Receive an instant verdict with confidence score. Download a watermarked verified image or share your results directly from the dashboard.
                </p>
              </div>
            </AnimatedSection>
          </div>
          ...
          <AnimatedSection delay={0.4}>
            <div className="text-center mt-12 lg:mt-16">
              <a
                ...
                onClick={() => trackCTA("start_detecting", "how_it_works")}
              >
                Try it free — 200 images/month
