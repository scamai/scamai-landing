  ...
  return (
    <aside
      className={`z-10 fixed top-16 h-[calc(100dvh-80px)] overflow-y-auto flex flex-col transition-all duration-300 ${
        isVisible ? "left-0 w-[200px]" : "-left-[200px] w-[200px]"
      }`}
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-hidden">
          <div className="relative min-w-[280px] md:min-w-0">
            ...
            >
              <nav
                className="flex flex-col gap-2 px-4 pt-10"
                aria-label="Primary"
              >
                {mainLinks.map((item) => {
                  if (item === "Use Cases") {
                    return (
                      <button
                        ...
                        onClick={() => {
                          setSubmenu(
                            submenu === "business" ? "none" : "business"
                          );
                          if (submenu !== "business") {
                  ...
                  if (item === "Research") {
                    return (
                      <button
                        ...
                        onClick={() => {
                          setSubmenu(
                            submenu === "research" ? "none" : "research"
                          );
                          if (submenu !== "research") {
                ...
                {businessLinks.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      href={href}
                      target={
                        item === "API Documentation" ? "_blank" : undefined
                      }
                      rel={
                        item === "API Documentation"
                          ? "noopener noreferrer"
