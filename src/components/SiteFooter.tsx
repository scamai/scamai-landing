...
export default function SiteFooter() {
  return (
    <footer className="bg-[#05050f] border-t border-white/10 text-slate-100 py-16 w-full">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-300">
              <li><a href="/stories/skydeck" className="hover:text-white transition-colors">About (Our Story)</a></li>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-slate-400 text-sm">
