        ...
        <main className="pt-[78px] relative z-10">
          ...
          <section className="relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto px-6 py-24 md:py-32 text-center relative">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 text-xs uppercase tracking-[0.2em] text-indigo-200 mb-6">
                Hacker Chic · Enterprise Grade · Dark Mode
              </div>
              <h1 className="text-4xl md:text-6xl font-semibold leading-tight md:leading-[1.05] text-white mb-6">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 mb-12">
                ...
                <a
                  ...
                  className="px-8 py-3 border border-white/40 text-white font-semibold tracking-tight hover:bg-white/5 transition"
                >
                  Get API Key
                </a>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-left max-w-5xl mx-auto">
                {[
                  ...
                  <div
                    key={item.title}
                    className="p-5 border border-white/10 bg-white/5 backdrop-blur-sm hover:border-indigo-400/40 transition"
                  >
          ...
          {/* Playground */}
          <section id="playground" className="py-20 border-t border-white/5">
            <div className="max-w-6xl mx-auto px-6">
              <div className="flex items-center justify-between flex-wrap gap-4 mb-8">
                <div>
                  <p className="text-xs uppercase tracking-[0.2em] text-indigo-200 mb-2">
                    Product-led
                  </p>
              ...
              <div className="bg-white/5 border border-white/10 backdrop-blur-lg p-6 md:p-8 relative overflow-hidden">
                <div className="absolute inset-0 pointer-events-none bg-gradient-to-tr from-indigo-500/10 via-transparent to-blue-500/5" />
                <div className="relative">
                  <div className="flex flex-wrap gap-3 mb-6">
                    {playgroundTabs.map((tab) => (
                      ...
                      >
                        <span>{tab.label}</span>{" "}
                        {tab.badge && (
                          <span className="ml-2 text-[10px] uppercase tracking-[0.16em] text-indigo-200">
                            {tab.badge}
                          </span>
                        )}
                      </button>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div
                      className="border border-white/10 bg-black/40 p-5 h-full flex flex-col justify-between"
                    ...
                    >
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          <p className="text-sm text-slate-300">Upload Area</p>
                      ...
                      <div className="flex-1 border border-dashed border-white/20 bg-white/5 min-h-[220px] flex items-center justify-center text-center px-6">
                    ...
                    <div className="relative border border-white/10 bg-black/60 p-5 flex flex-col gap-4">
                      {demoCount >= 5 && (
                        <div className="absolute inset-0 bg-black/60 backdrop-blur-xl border border-white/10 flex flex-col items-center justify-center text-center px-6">
                      ...
                      <div className="border border-white/10 bg-white/5 p-4">
                        <p className="text-slate-200">{playgroundResult.analysis}</p>
                      </div>
                      <div className="flex items-center justify-between">
                        <p className="text-slate-300">{playgroundResult.action}</p>
                        <a
                          href="#developer"
                          className="text-indigo-200 hover:text-white text-sm font-semibold"
                        >
                          Integrate API →
                        </a>
                      </div>
          ...
          {/* Trust */}
          <section className="py-16 border-t border-white/5 bg-gradient-to-b from-[#05050f] to-[#020208]">
            <div className="max-w-6xl mx-auto px-6">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="space-y-3">
                  ...
                  <a href="/stories/skydeck" className="text-indigo-200 hover:text-white font-semibold">
                    Read Our Story →
                  </a>
                </div>
              </div>
          ...
          {/* Problem */}
          <section className="py-20 border-t border-white/5 bg-[#05050f]">
            <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
              <div className="relative border border-red-500/20 bg-black/60 p-4 overflow-hidden">
                ...
                <div className="iphone-frame">
                  ...
                  {videoOverlay && (
                    <button
                      ...
                      className="absolute inset-0 bg-black/70 flex flex-col items-center justify-center text-center px-6 hover:bg-black/60 transition"
                    >
                      <span className="text-sm uppercase tracking-[0.18em] text-red-200 mb-2">
                        Red Team Footage
                      </span>
              ...
              <div>
                <p className="text-sm uppercase tracking-[0.2em] text-red-200 mb-3">
                ...
                <div className="grid grid-cols-1 gap-4">
                  {[
                    ...
                    <div
                      key={stat}
                      className="p-4 border border-white/10 bg-white/5 flex items-center justify-between"
                    >
                      <p className="text-lg font-semibold text-red-100">{stat}</p>
          ...
          {/* Solutions */}
          <section className="py-20 border-t border-white/5 bg-gradient-to-b from-[#04040a] via-[#05050f] to-[#04040a]">
                ...
                <div className="space-y-3">
                  {(["vision", "audio", "firewall"] as SolutionTab[]).map((key) => (
                    ...
                    >
                      ...
                      <p className="text-slate-300 text-sm">{solutionTabs[key].description}</p>
                    </button>
                  ))}
                </div>
              </div>
              <div className="lg:col-span-3 border border-white/10 bg-white/5 p-6 relative overflow-hidden">
                <div className="absolute -right-10 -top-10 h-40 w-40 bg-indigo-500/20 blur-3xl" />
                <div className="relative">
                  <p className="text-sm uppercase tracking-[0.18em] text-indigo-200 mb-2">
                    Threat Analysis
                  </p>
                  <h4 className="text-2xl font-semibold mb-4">{solutionTabs[activeSolution].title}</h4>
                  <p className="text-slate-200 mb-6">{solutionTabs[activeSolution].description}</p>
                  <div className="grid md:grid-cols-2 gap-4 mb-6">
                    {solutionTabs[activeSolution].bullets.map((item) => (
                      <div key={item} className="p-4 border border-white/10 bg-black/40">
                  ...
                  <div className="border border-white/10 bg-black/60 p-4">
                    <div className="flex items-center justify-between mb-2">
                      <p className="text-sm text-slate-300">Live log · Blocked Requests</p>
          ...
          <section id="developer" className="py-20 border-t border-white/5 bg-[#05050f]">
            <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-start">
              <div>
                ...
                <a
                  href="/docs"
                  className="inline-flex mt-6 px-5 py-2 border border-white/20 text-indigo-100 hover:bg-white/5 font-semibold"
                >
                  Read the Documentation →
                </a>
              </div>
              <div className="border border-white/10 bg-black/70 p-5 shadow-[0_0_45px_rgba(79,70,229,0.25)]">
                <div className="flex items-center justify-between text-xs text-slate-400 mb-3">
                  <span>Python SDK</span>
                  <span className="text-indigo-200">Latency target: &lt;100ms</span>
                </div>
                <pre className="text-sm text-slate-100 bg-black/40 p-4 overflow-x-auto">
{`import scamai
...
if check.is_fake:
    print(f"Blocked: {check.reason} ({check.confidence}%)")`}
          ...
          {/* Pricing */}
          <section className="py-20 border-t border-white/5 bg-gradient-to-b from-[#04040a] to-[#020206]">
            <div className="max-w-6xl mx-auto px-6">
              <div className="flex items-center justify-between flex-wrap gap-4 mb-8">
                <div>
                  <p className="text-xs uppercase tracking-[0.2em] text-indigo-200 mb-2">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="md:col-span-2 border border-white/10 bg-white/5 p-6">
                ...
                <div className="border border-white/10 bg-black/70 p-6">
                  <p className="text-sm uppercase tracking-[0.18em] text-indigo-200 mb-2">
                    Estimated Cost
                  </p>
                  <p className="text-3xl font-semibold mb-2">{priceLabel}</p>
                  <p className="text-slate-300 text-sm mb-4">Includes 10,000 API calls</p>
          ...
          {/* Final CTA */}
          <section id="final-cta" className="py-20 border-t border-white/5 bg-[#05050f]">
            <div className="max-w-3xl mx-auto px-6 text-center">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 mb-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-7 py-3 border border-white/30 text-white hover:bg-white/5 transition font-semibold"
                >
