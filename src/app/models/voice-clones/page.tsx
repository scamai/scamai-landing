...
const voiceClonesPageData: ProductPageProps = {
  ...
  hero: {
    ...
    description: "Our VoiceGuard model instantly identifies synthetic speech and deepfake audio, stopping voice-based fraud in real time. It can detect synthetic audio like Sale0625.mp3, which was generated by minimax.io.",
