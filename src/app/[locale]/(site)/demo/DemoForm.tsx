...
export default function DemoForm() {
  ...
  return (
    <>
      {/* Form container (hidden on success) */}
      <div className={success ? "hidden" : "block"}>
        <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-1 gap-4">
          ...
          <div className="mt-2 text-sm text-white/70">
            By submitting, you&apos;ll be contacted by our team to arrange a <strong>15‑minute discovery call</strong>, followed by a <strong>30‑minute live demo</strong> tailored to your use case.
          </div>
      ...
      {success && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          {/* Card */}
          <div className="relative z-10 w-[min(92vw,640px)] rounded-2xl border border-white/10 bg-neutral-900/80 p-8 shadow-2xl">
            <div className="mx-auto mb-5 h-10 w-10 rounded-full bg-emerald-500/20 grid place-items-center">
              <svg className="h-6 w-6 text-emerald-400" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
              </svg>
            </div>
            <h3 className="text-center text-2xl font-semibold tracking-tight">Thank you for your request</h3>
            <div className="mt-3 space-y-3 text-center text-white/80">
              <p><strong className="text-white">Our team will contact you within 24 hours</strong> with a personalized plan tailored to your requirements.</p>
