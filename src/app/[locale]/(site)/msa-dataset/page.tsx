    ...
    <div className="min-h-screen bg-zinc-900">
      ...
      <div className="border-b border-zinc-800">
        <div className="max-w-3xl mx-auto px-6 py-16">
          <h1 className="text-3xl font-medium text-zinc-100 mb-2">
            Dataset License Agreement
          </h1>
          <p className="text-zinc-400">Reality Inc. Dataset Licensing</p>
        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">1.1 License Grant</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">1.2 Use Restrictions</h3>
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">1.3 Delivery</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">1.4 No Maintenance or Support</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">1.5 Ethical Use</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">1.6 Mitigation of Harm</h3>
                <p className="text-zinc-300 leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">2.1 License Fee</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">2.2 Taxes</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">2.3 Recordkeeping</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">2.4 Audit Rights</h3>
                <p className="text-zinc-300 leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">3.1 Ownership</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">3.2 Derivative Works</h3>
                <p className="text-zinc-300 leading-relaxed mb-4">
                ...
                <p className="text-zinc-300 leading-relaxed mb-3 ml-4">
                ...
                <p className="text-zinc-300 leading-relaxed ml-4">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">3.3 Feedback</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">3.4 Attribution</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">3.5 Trademark License</h3>
                <p className="text-zinc-300 leading-relaxed mb-4">
                ...
                <p className="text-zinc-300 leading-relaxed mb-2 ml-4">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">3.6 Third-Party Infringement</h3>
                <p className="text-zinc-300 leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">4.1 Definition</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">4.2 Non-Disclosure</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">4.3 Publicity</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">4.4 Data Security and Privacy</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">4.5 Return of Materials</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">4.6 Injunctive Relief</h3>
                <p className="text-zinc-300 leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">5.1 Mutual</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">5.2 By Licensee</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">5.3 By Reality Inc.</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">5.4 Disclaimer</h3>
          ...
          <section>
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">6.1 Termination for Breach</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">6.2 Additional Reality Inc. Termination Rights</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">6.3 Effect of Termination</h3>
                <p className="text-zinc-300 leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">8.1 By Licensee</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">8.2 By Reality Inc.</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">8.3 Procedure</h3>
                <p className="text-zinc-300 leading-relaxed">
          ...
          <section>
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">10.1 Amendments</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">10.2 Assignment</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">10.3 Binding Effect</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">10.4 Compliance with Laws</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">10.5 Construction</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">10.6 Dispute Resolution</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">10.7 Export Regulation</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">10.8 Force Majeure</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">10.9 Governing Law</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">10.10 Legal Fees</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">10.11 Nonsolicitation</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">10.12 Notices</h3>
                <p className="text-zinc-300 leading-relaxed mb-4">
                ...
                <div className="ml-4 text-zinc-300 leading-relaxed space-y-1">
                  <p>Reality Inc.</p>
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">10.13 Relationship of Parties</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">10.14 Third-Party Beneficiaries</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">10.15 Waiver</h3>
                <p className="text-zinc-300 leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-medium text-zinc-100 mb-3">10.16 Entire Agreement</h3>
                <p className="text-zinc-300 leading-relaxed">
